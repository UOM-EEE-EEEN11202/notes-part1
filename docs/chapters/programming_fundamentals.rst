...
Some of the later topics, those from :ref:`stack and heap memory <stack_and_heap>` and after, are relatively advanced and relate more to the latter half of the course on lower level languages. You may like to revisit these later in the course. 
...
.. toctree::
   ...
   programming_fundamentals/asserts_and_exceptions
   programming_fundamentals/design_patterns
   programming_fundamentals/copies
   programming_fundamentals/memory_management
