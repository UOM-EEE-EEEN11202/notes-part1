...
We're going to use the `VSCode <https://code.visualstudio.com/>`_ IDE. (Don't confuse VSCode with Visual Studio. Both are made by Microsoft, both have similar names, and both are installed on the University computers, but they are different programs.) 
